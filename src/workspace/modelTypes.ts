...
export type Binding = {source:"local"|"service";base_url:string;has_key:boolean;api_key?:string|null;model:string;dimensions:number|null;disable_reasoning:boolean;max_output_tokens:number|null;output_token_parameter:"max_tokens"|"max_completion_tokens"};
...
export const emptyBinding = ():Binding => ({source:"local",base_url:"",has_key:false,model:"",dimensions:null,disable_reasoning:false,max_output_tokens:null,output_token_parameter:"max_tokens"});
