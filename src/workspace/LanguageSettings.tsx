...
export default function LanguageSettings() {
  ...
  return <section className="language-settings">
    ...
    <div className="language-setting-copy"><h3 id="ui-language-label">{t('language')}</h3><p id="ui-language-description">{t('languageDescription')}</p></div>
    <div className="language-segments" role="radiogroup" aria-labelledby="ui-language-label" aria-describedby="ui-language-description" aria-busy={busy}>
