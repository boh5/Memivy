...
Follow `docs/RELEASING.md`: after verification and packaging pass, CI publishes
a stable release directly. Validate local artifacts before pushing a release tag.
